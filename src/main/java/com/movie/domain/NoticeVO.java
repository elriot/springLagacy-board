...
public class NoticeVO {
	...
	public String toString() {
		...
		builder.append("NoticeVO [nt_num=");
		builder.append(nt_num);
		builder.append(", mb_ID=");
		builder.append(mb_ID);
		builder.append(", nt_subject=");
		builder.append(nt_subject);
		builder.append(", nt_content=");
		builder.append(nt_content);
		builder.append(", nt_fileName=");
		builder.append(nt_fileName);
		builder.append(", nt_writeDate=");
		builder.append(nt_writeDate);
		builder.append(", nt_writeIP=");
		builder.append(nt_writeIP);
		builder.append(", nt_readCount=");
		builder.append(nt_readCount);
		builder.append("]");

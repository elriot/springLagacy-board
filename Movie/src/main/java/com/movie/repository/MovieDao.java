...
public class MovieDao {
	...
	// 선택 가능한 영화 타이틀 가져오기
	   ...
	   public List<MovieVO> getAbleDate(String mv_title, String mv_date){
	      ...
	      List<MovieVO>list = jdbcTemplate.query(sql, new BeanPropertyRowMapper<MovieVO>(MovieVO.class), mv_date, mv_title);
	      return list;
	   }
	   ...
	   public List<MovieVO> getAbleTheather(String mv_title, String mv_date, String mv_time){
	      ...
	      List<MovieVO>list = jdbcTemplate.query(sql, new BeanPropertyRowMapper<MovieVO>(MovieVO.class), mv_date, mv_title, mv_time);
	      return list;
	   }	
}

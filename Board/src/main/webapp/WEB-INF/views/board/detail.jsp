	...
	<div class="row">
		...
		<div class="col-lg-8 mx-auto">
			<div class="card my-4">
				...
				<div class="card-body">
					...
					<input type="button" class="btn btn-primary float-right" value="작성완료" onclick="sendReply()"/>
				</div>
			</div>
		</div>
		<hr>
		...
		<div id="reply" class="col-lg-8 mx-auto">		
			<c:forEach var="item" items="${list}">
				...
				<i class='material-icons'>cancel</i></a><br>
				${item.rContent}
			  </div>			
			</c:forEach>
		</div>
...
<script>
	function addDiv(rNum, bNum, userID, rContent){ 
		...
		//newDiv.className="col-lg-8 mx-auto";
		newDiv.innerHTML="<b>"+userID+"</b> <a href='/reply/delete?rNum="+rNum
				+"&bNum="+bNum+"'><i class='material-icons'>cancel</i></a><br>"+rContent;
	...
	function sendReply(){
		...
		//console.log(rJson); 스트링형태의 json데이터로 만듦
